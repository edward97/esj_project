$(document).ready(function() {
    ...
    $(document).on("click", "[data-edit]", function() {
        ...
        $.ajax({
            url: url+"setup/item/edit/"+id,
            type: "get",
            dataType: "json",
            success: function(data) {
                $('[name="item-id"]').val(data.id_item);
                $('[name="item-nm"]').val(data.nm_item);
                $('[name="item-uom"]').val(data.uom);
    ...
    $(document).on("click", "#save-data", function() {
        ...
        // url
        path = (sv_method === "create") ? url+"setup/item/add" : url+"setup/item/update";
