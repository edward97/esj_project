                            ...
                            <div class="card-header clearfix">
                                <div class="float-left">
                                    <ul class="list-custom">
                                        ...
                                        <li class="list-custom-item text-muted"><i class="fas fa-chart-bar fa-sm"></i> Purchase Order</li>
                                    </ul>
                                </div>
                    ...
                    <form id="form-data">
                        <div class="card-header clearfix">
                            <div class="float-left">
                                <ul class="list-custom">
                                    <li class="list-custom-item"><i class="fas fa-code-branch fa-sm"></i> Transaction</li>
                                    <li class="list-custom-item text-muted"><i class="fas fa-list fa-sm"></i> Purchase Order</li>
                                </ul>
                            </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalLabel">List Purchase Order</h5>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-sm btn-outline-info" data-action="reload"><i class="fas fa-sync-alt"></i> Reload</button>
